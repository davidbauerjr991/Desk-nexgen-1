...
export const customerDatabase: CustomerSeedRecord[] = [
      ...
      // ── Phase 4: Current Case ───────────────────────────────────────────────
      {
        ...
        interaction: {
          ...
          messages: [
            ...
            { sender: "bot", name: "Jacob", text: "I'm going to transfer you to a live customer service agent, please hold.", time: "9:52 AM" },
          ],
        },
      },
      {
 ...
 author: "Jacob", content: "Hi Sofia — I've reviewed both transactions and they've been flagged as suspicious. I'm escalating this to our fraud team now.", time: "9:47 AM" },
      ...
      },
      {
        ...
        interaction: {
          ...
          messages: [
            ...
            { sender: "bot", name: "Emily", text: "I'm going to transfer you to a live customer service agent, please hold.", time: "10:14 AM" },
          ],
        },
      },
      {
  ...
  },
  {
    ...
    customerSnapshot: [
      "VP of Operations at Nexus Freight — mid-sized logistics company (~200 employees)",
      "Evaluating TMS replacement; spent 4m 12s on Enterprise Pricing page",
      "Browsed ROI Calculator and Integrations page — strong buying intent signals",
      "Inbound callback request — high-priority sales lead",
    ],
  },
  // ── Elena Vasquez — Cross-Sell Opportunity (missing item + accessory bundle) ──
  {
    id: "elena",
    initials: "EV",
    name: "Elena Vasquez",
    customerId: "CST-14402",
    lastUpdated: "05/14/26 | 10:18 AM",
    profile: {
      department: "Consumer",
      tenureYears: 0,
      totalAUM: "$1,849.00",
    ...
    conversationTopics: [
      "Resolve missing 64GB memory card from Luminos Pro kit",
      "Restore customer confidence after fulfillment error",
      "Present Start Strong accessory bundle if receptive",
    ],
    contact: {
      email: "elena.vasquez@email.com",
      phone: "(415) 555-0247",
      address: { street: "1482 Mariposa St", city: "San Francisco", state: "CA", zip: "94107", country: "US" },
    },
    accounts: [
      { id: "ev-consumer", type: "Checking", number: "CST-14402", balance: null, availableBalance: null, status: "active", openedDate: "Apr 2026" },
    ],
    overview: {
    ...
    interactionTimeline: [
      {
        id: "elena-order-placed",
        title: "Order #EV-44071 placed — Luminos Pro 4K Kit",
        timestamp: "May 7 · 2:15 PM",
        detail: "Elena purchased the Luminos Pro 4K mirrorless camera kit ($1,849) including 24–70mm lens, camera strap, and 64GB memory card.",
        tone: "info",
        sortOrder: 1,
      },
      {
        id: "elena-order-shipped",
        title: "Order shipped — FedEx Express",
        timestamp: "May 8 · 9:30 AM",
        detail: "Order dispatched from warehouse. Packing log shows all items scanned as included at dispatch.",
        tone: "info",
        sortOrder: 2,
      },
      {
        id: "elena-order-delivered",
        title: "Order delivered",
        timestamp: "May 13 · 3:42 PM",
        detail: "Package delivered to front door. Signed by recipient.",
        tone: "info",
        sortOrder: 3,
      },
      {
        id: "elena-chat-open",
        title: "Customer opened support chat",
        timestamp: "Today · 10:18 AM",
        detail: "Elena reports 64GB memory card missing from Luminos Pro kit. Packing slip lists it but item not in box.",
        tone: "warning",
        sortOrder: 4,
      },
      {
        id: "elena-discrepancy-flagged",
        title: "Packing discrepancy flagged",
        timestamp: "Today · 10:19 AM",
        detail: "Aria cross-referenced warehouse packing record — card scanned as included at dispatch. Discrepancy flagged internally.",
        tone: "warning",
        sortOrder: 5,
      },
      {
        id: "elena-escalated",
        title: "Customer requested human agent — case escalated",
        timestamp: "Today · 10:22 AM",
        detail: "Elena asked to speak with a person. High-value first purchase, confidence shaken. Aria escalated with full context.",
        tone: "critical",
        sortOrder: 6,
      },
    ],
    customerHistory: [
      {
        ...
        type: "purchase",
        phase: "Purchase",
        title: "Purchased Luminos Pro 4K Camera Kit",
        timestamp: "May 2026",
        detail: "Elena's first purchase — a Luminos Pro 4K mirrorless camera kit at $1,849.00. Kit includes 24–70mm lens, camera strap, and 64GB memory card.",
        dot: "blue",
        meta: [
          { label: "Order", value: "#EV-44071" },
          { label: "Total", value: "$1,849.00" },
          { label: "Items", value: "Camera body, 24–70mm lens, strap, 64GB card" },
        ],
        interaction: {
          kind: "purchase" as const,
          orderId: "EV-44071",
          items: [
            { name: "Luminos Pro 4K Camera Body", qty: 1, price: "$1,499.00" },
            { name: "24–70mm Lens", qty: 1, price: "$249.00" },
            { name: "Camera Strap", qty: 1, price: "$29.00" },
            { name: "64GB SD Memory Card", qty: 1, price: "$34.99" },
          ],
          total: "$1,849.00",
          paymentMethod: "Visa ****7183",
        },
      },
      {
        id: "elena-h2",
        type: "shipping",
        phase: "Fulfillment",
        title: "Order delivered — item missing",
        timestamp: "May 2026",
        detail: "Package delivered but 64GB memory card not included. Packing slip lists the card. Warehouse scan shows it was packed — likely fulfillment error.",
        dot: "orange",
        meta: [
          { label: "Carrier", value: "FedEx Express" },
          { label: "Delivered", value: "May 13, 3:42 PM" },
          { label: "Missing item", value: "64GB SD Memory Card" },
        ],
        interaction: {
          kind: "shipping" as const,
          carrier: "FedEx Express",
          trackingNumber: "FX-7724819305",
          events: [
            { status: "Shipped", location: "Warehouse — Memphis, TN", time: "May 8, 9:30 AM" },
            { status: "In Transit", location: "Oakland, CA", time: "May 12, 6:15 PM" },
            { status: "Delivered", location: "San Francisco, CA", time: "May 13, 3:42 PM", isDelivered: true },
          ],
        },
      },
      {
        ...
        type: "chat",
        phase: "Support",
        title: "Opened support chat — missing item report",
        timestamp: "May 2026",
        detail: "Elena contacted support to report the missing memory card. Aria confirmed the discrepancy and offered replacement or refund. Elena requested a human agent.",
        dot: "blue",
        meta: [
          { label: "Channel", value: "Web Chat" },
          { label: "AI Agent", value: "Aria" },
          { label: "Resolution offered", value: "Overnight replacement or $34.99 refund" },
        ],
        interaction: {
          kind: "chat" as const,
          botName: "Aria",
          messages: [
            { sender: "customer" as const, text: "I just received my Luminos Pro camera kit and the memory card that was supposed to be included is missing from the box." },
            { sender: "bot" as const, name: "Aria", text: "I'm really sorry about that, Elena — I can see the memory card was listed on your packing slip. Let me look into getting that resolved for you right away." },
            { sender: "customer" as const, text: "I want the card sent to me but honestly I'm not confident this is going to get handled properly. I'd feel better speaking with an actual person." },
          ],
        },
      },
    ],
    ...
    conversations: {
        ...
        messages: [
          {
            id: 1,
            role: "customer",
            content: "I just received my Luminos Pro camera kit and the memory card that was supposed to be included is missing from the box.",
            time: "10:18 AM",
          },
          {
            id: 2,
            ...
            author: "Aria",
            content:
              "I'm really sorry about that, Elena — a missing item from an order this important is completely unacceptable. I can see the memory card was listed on your packing slip. Let me look into getting that resolved for you right away.",
            time: "10:19 AM",
          },
          {
            id: 3,
            ...
            author: "Aria",
            content:
              "I've pulled up your order #EV-44071 and confirmed the kit should include the 64GB memory card. Our warehouse packing record shows it was scanned as included at dispatch, so this looks like a fulfillment error on our end. I can either ship a replacement card overnight — you'd have it tomorrow — or I can refund the card's standalone value of $34.99 to your account. Which would you prefer?",
            time: "10:20 AM",
          },
          {
            id: 4,
            role: "customer",
            content:
              "I want the card sent to me but honestly I'm not confident this is going to get handled properly. I'd feel better speaking with an actual person.",
            time: "10:21 AM",
            sentiment: "frustrated",
          },
          {
            ...
            author: "Aria",
            content:
              "Absolutely, Elena — I'm connecting you with one of our senior customer care specialists right now. Everything we've discussed will be waiting for them so you won't have to repeat yourself.",
            time: "10:22 AM",
          },
          {
            id: 6,
            role: "agent",
            author: "Aria",
            content: "Elena purchased a Luminos Pro 4K camera kit ($1,849) — her first serious photography investment. The 64GB memory card listed on the packing slip is missing from the shipment. Warehouse packing log shows it was scanned as included at dispatch — likely a fulfillment error.\n\nI offered overnight replacement or a $34.99 refund. Elena chose replacement but requested a human agent — her confidence in us has taken a hit.\n\nCustomer Snapshot:\n• First-time buyer — account created 6 weeks ago, this is her only order\n• High-value purchase ($1,849) — saved for 3 months\n• No prior complaints or returns\n• Described this as her first serious investment in photography\n• Frustrated but not angry — wants reassurance, not escalation",
            time: "10:22 AM",
            isInternal: true,
            isHandoffCard: true,
          },
      ...
      email: {
        label: "Email",
        timelineLabel: "Email · Today, 10:18 AM",
        draft: "Hi Elena, thank you for reaching out about your Luminos Pro camera kit. I'm looking into the missing memory card right now and will have this resolved for you shortly.",
        messages: [
          { id: 1, role: "customer", content: "I received my Luminos Pro camera kit today and the 64GB memory card that was listed on the packing slip is not in the box. Can someone look into this?", time: "10:18 AM" },
          { id: 2, role: "agent", author: "Aria", content: "Thank you for reaching out, Elena. I've confirmed your order #EV-44071 and can see the memory card was listed. I'm escalating this to a senior specialist who can resolve it quickly.", time: "10:19 AM" },
        ],
      },
      sms: {
        label: "SMS",
    ...
    customerSnapshot: [
      "First-time buyer — account created 6 weeks ago, only order on file",
      "High-value purchase: Luminos Pro 4K camera kit at $1,849",
      "Saved for 3 months — described as first serious photography investment",
      "No prior complaints; frustrated but reasonable — wants reassurance",
      "Cross-sell opportunity: likely to need accessories within 90 days",
    ],
  },
  {
    id: "alex_sanderson",
    ...
    profile: {
      ...
      financialReadiness: 0,
      financialAdvisor: "Sarah Jones",
      advisorTitle: "Travel Support Specialist",
      tags: ["Platinum", "Storm Disruption", "Partner Rebooking"],
      fraudRiskScore: 0,
      priorDisputeCount: 0,
      cardBlocked: false,
      ...
      loyaltyPoints: 430000,
      homeAirport: "MSP",
      travelType: "Business",
    },
    conversationTopics: [
      "Mechanical delay — VY-4450 MSP→LHR",
      "Connection at risk — LHR→FCO",
      "Partner airline rebooking requires premium upgrade authorization",
    ],
    contact: {
      email: "alex.sanderson@meridiangroup.com",
      phone: "(612) 555-4871",
      address: { street: "4120 France Ave S", city: "Edina", state: "MN", zip: "55424", country: "US" },
    },
    accounts: [],
    overview: {
      contactNumber: "(612) 555-4871",
      assignedAgent: "Unassigned",
      pronoun: "he",
      lastContactTime: "Today, 10:08 AM",
      address: "Edina, MN 55424",
    },
    interactionTimeline: [
      {
        id: "alex_sanderson-delay-detected",
        title: "Mechanical delay detected on VY-4450",
        timestamp: "Today · 9:42 AM",
        detail: "Emily detected a mechanical issue on VY-4450 MSP→LHR resulting in a 2-hour departure delay. Alex Sanderson's itinerary was flagged for downstream connection risk.",
        tone: "warning",
        sortOrder: 1,
      },
      {
        id: "alex_sanderson-routing-evaluated",
        title: "Alternate routing evaluated",
        timestamp: "Today · 9:55 AM",
        detail: "Emily evaluated 6 alternate routings to protect Alex's LHR→FCO connection on VY-7821. Most options would not arrive in time for his Rome commitment.",
        tone: "info",
        sortOrder: 2,
      },
      {
        id: "alex_sanderson-partner-option",
        title: "Partner premium option identified — exceeds auth threshold",
        timestamp: "Today · 10:03 AM",
        detail: "Emily identified a British Airways premium cabin seat that would protect the Rome connection, but the fare difference of $680 exceeds the automated $500 authorization threshold.",
        tone: "critical",
        sortOrder: 3,
      },
      {
        id: "alex_sanderson-escalated",
        title: "Escalated to human specialist for authorization",
        timestamp: "Today · 10:08 AM",
        detail: "Emily escalated to a human agent because the best re-routing requires a partner airline premium cabin upgrade that exceeds the $500 automated authorization limit.",
        tone: "critical",
        sortOrder: 4,
      },
    ],
    customerHistory: [
      {
        id: "alex_sanderson-h1",
        type: "registration",
        phase: "Account History",
        title: "Voyager Horizons account created",
        timestamp: "May 2018",
        detail: "Alex Sanderson created a Voyager Horizons account and enrolled in the loyalty program. Welcome bonus of 5,000 points credited.",
        dot: "gray",
      },
      {
        id: "alex_sanderson-h2",
        type: "system",
        title: "Frequent business traveler — 34 trips booked",
        timestamp: "May 2018 – May 2026",
        detail: "Alex has maintained his Voyager account for 8 years with 34 completed trips, primarily transatlantic business routes. Consistent booking patterns with premium cabin preferences.",
        dot: "green",
      },
      {
        id: "alex_sanderson-h3",
        type: "system",
        phase: "Loyalty",
        title: "Upgraded to Voyager Platinum",
        timestamp: "Mar 2022",
        detail: "Alex reached Platinum tier after accumulating 300,000 loyalty points. Benefits include priority rebooking, lounge access, and complimentary upgrades when available.",
        dot: "purple",
      },
      {
        id: "alex_sanderson-h4",
        type: "purchase",
        phase: "Current Trip",
        title: "Booked VY-4450 MSP→LHR",
        timestamp: "Apr 24, 2026 · 2:15 PM",
        detail: "Alex booked flight VY-4450 from Minneapolis-St. Paul to London Heathrow. Business class, departing May 15.",
        dot: "blue",
      },
      {
        id: "alex_sanderson-h5",
        type: "purchase",
        title: "Added connection VY-7821 LHR→FCO",
        timestamp: "Apr 26, 2026 · 11:30 AM",
        detail: "Alex added a connecting flight VY-7821 from London Heathrow to Rome Fiumicino. Connection window of 2 hours 40 minutes at LHR.",
        dot: "blue",
      },
      {
        id: "alex_sanderson-h6",
        type: "system",
        title: "Online check-in completed",
        timestamp: "May 14, 2026 · 6:00 PM",
        detail: "Alex completed online check-in for VY-4450 MSP→LHR. Seat 4A confirmed. Boarding pass issued to mobile device.",
        dot: "green",
      },
      {
        id: "alex_sanderson-h7",
        type: "ticket",
        phase: "Disruption",
        title: "Mechanical delay detected — VY-4450",
        timestamp: "Today · 9:42 AM",
        detail: "Operations reported a mechanical issue on VY-4450. Estimated delay of 2 hours. Emily flagged the downstream connection risk for VY-7821 LHR→FCO.",
        dot: "red",
        customerMessage: "I've been planning this Rome trip for months. Please tell me there's a way to make this work.",
      },
      {
        id: "alex_sanderson-h8",
        type: "chat",
        title: "Emily proactively contacted Alex",
        timestamp: "Today · 9:48 AM",
        detail: "Emily reached out to Alex before he was aware of the delay to inform him of the mechanical issue and begin exploring alternatives.",
        dot: "blue",
      },
      {
        id: "alex_sanderson-h9",
        type: "handoff",
        title: "Escalated — partner upgrade exceeds authorization",
        timestamp: "Today · 10:08 AM",
        detail: "Emily escalated to a human specialist. The best re-routing option is a British Airways premium cabin seat at $680 above the original fare, which exceeds the $500 automated authorization threshold. Alex's LHR→FCO connection window closes in approximately 3 hours.",
        dot: "red",
        customerMessage: "I understand it's complicated. I just really need to get to Rome today.",
      },
    ],
    queue: {
      time: "3m",
      ...
      updatedAt: "2026-05-15T10:08:00",
    },
    escalationResponses: [
      "Thank you for your patience, Alex. I completely understand how important this Rome trip is. I've reviewed the routing options Emily identified and I'm going to authorize the British Airways premium cabin upgrade to protect your connection.",
      "Great news — I've confirmed your seat on the British Airways flight through Heathrow. Your Rome arrival time is preserved and you'll have a comfortable ride. I'm updating your itinerary now.",
      "Everything is set, Alex. Your new routing is confirmed: VY-4450 MSP→LHR, then BA premium cabin LHR→FCO. You'll arrive in Rome on schedule. Is there anything else I can help with before your flight?",
    ],
    conversations: {
      chat: {
        label: "Chat",
        timelineLabel: "Web chat · Today, 9:48 AM",
        draft: "",
        messages: [
          {
            id: 1,
            role: "agent",
            author: "Emily",
            content: "Hi Alex — this is Emily from Voyager. I'm reaching out because I've detected a mechanical issue on your flight VY-4450 from Minneapolis to London. There's an estimated 2-hour delay, and I want to get ahead of this for you.",
            time: "9:48 AM",
          },
          {
            id: 2,
            role: "customer",
            content: "Oh no — I have a connection at Heathrow to Rome. Is that going to be affected?",
            time: "9:50 AM",
            sentiment: "frustrated",
          },
          {
            ...
            role: "agent",
            author: "Emily",
            content: "Yes, that's exactly why I'm contacting you now. The 2-hour delay on VY-4450 puts your VY-7821 LHR→FCO connection at serious risk. I've been evaluating alternate routings to protect your Rome arrival.",
            time: "9:52 AM",
          },
          {
            id: 4,
            role: "customer",
            content: "I've been planning this Rome trip for months. Please tell me there's a way to make this work.",
            time: "9:54 AM",
            sentiment: "frustrated",
          },
          {
          ...
          },
          {
            ...
            role: "agent",
            author: "Emily",
            content: "Transferring to a travel specialist now. Context: Platinum member, 8-year tenure, 430K points. VY-4450 MSP→LHR has a 2-hour mechanical delay putting VY-7821 LHR→FCO at risk. Best re-routing is BA premium cabin at $680 over original fare — exceeds $500 auto-auth threshold. Connection window closes in ~3 hours. Rome trip planned for months.",
            time: "10:08 AM",
            isInternal: true,
            isHandoffCard: true,
          },
      ...
      sms: {
        label: "SMS",
        timelineLabel: "SMS · Today, 9:48 AM",
        draft: "Hi Alex — I've reviewed the situation with your VY-4450 delay and the connection risk to Rome. I'm authorizing the British Airways upgrade now to make sure you get there on time.",
        messages: [
          { id: 1, role: "agent", author: "Emily", content: "Hi Alex — Voyager here. Your flight VY-4450 has a mechanical delay. I'm working on protecting your Rome connection.", time: "9:48 AM" },
          { id: 2, role: "customer", content: "Thanks for the heads up. What are my options?", time: "9:51 AM" },
          { id: 3, role: "customer", content: "I really need to make it to Rome today.", time: "9:55 AM", sentiment: "frustrated" },
        ],
      },
      whatsapp: {
        label: "WhatsApp",
        timelineLabel: "WhatsApp · Today, 9:48 AM",
        draft: "Alex, I've found the best routing to get you to Rome on time. Authorizing the partner upgrade now — I'll confirm your new itinerary shortly.",
        messages: [
          { id: 1, role: "agent", author: "Emily", content: "Hi Alex — Emily from Voyager. I've detected a delay on VY-4450 and I'm proactively working on your LHR→FCO connection.", time: "9:48 AM" },
          { id: 2, role: "customer", content: "I just saw the delay notification. What's happening with my Rome flight?", time: "9:52 AM" },
          { id: 3, role: "customer", content: "This trip has been planned for months — please help me make it work.", time: "9:56 AM", sentiment: "frustrated" },
        ],
      },
      email: {
        label: "Email",
        timelineLabel: "Email thread · Today, 9:48 AM",
        draft: "Hi Alex — I've reviewed the delay on VY-4450 and the impact on your Heathrow connection to Rome. I'm authorizing the British Airways premium cabin upgrade to ensure you arrive on schedule. Full itinerary update to follow.",
        messages: [
          { id: 1, role: "agent", author: "Emily", content: "Subject: Action needed — VY-4450 delay affecting your Rome connection\n\nHi Alex,\n\nI'm reaching out proactively because your flight VY-4450 MSP→LHR has encountered a mechanical delay of approximately 2 hours. This puts your connecting flight VY-7821 LHR→FCO at risk. I'm evaluating alternate routing options and will update you shortly.", time: "9:48 AM" },
          { id: 2, role: "customer", content: "Thank you for the proactive notice. I've been planning this Rome trip for months and need to arrive today. Please do whatever it takes to protect the connection.", time: "9:53 AM" },
          { id: 3, role: "agent", author: "Emily", content: "Hi Alex — I've identified a British Airways premium cabin routing that would protect your Rome arrival. The upgrade requires specialist authorization, which I'm arranging now. I'll confirm your updated itinerary as soon as it's approved.", time: "10:00 AM" },
        ],
      },
    },
    resolveFlow: {
      type: "supervisor",
      steps: [
        "Authorizing British Airways premium cabin upgrade ($680)",
        "Confirming partner airline seat reservation",
        "Updating Alex's itinerary — VY-4450 → BA LHR→FCO",
        "Issuing revised boarding documents to mobile device",
      ],
      supervisorName: "Sarah Jones",
    },
    seedHasTransferMessage: true,
    ...
    customerSnapshot: [
      ...
      "Rome trip has been planned for months — high personal importance",
